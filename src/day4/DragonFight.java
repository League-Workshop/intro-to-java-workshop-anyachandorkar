...
public class DragonFight {
	...
	int playerHealth = 100;
		...
		String attack = JOptionPane.showInputDialog(null, "Do you want to attack the dragon with a yell or kick?");
		...
		// 14. Else if the dragon's health is less than or equal to 0
			...
			JOptionPane.showMessageDialog(null, "The dragon is dead and you win tons of gold!");
	   //  15.  Else
		} else {
